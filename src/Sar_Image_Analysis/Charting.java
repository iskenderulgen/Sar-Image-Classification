...
public class Charting {
    ...
    public static void NB_Model_Accuracy_Chart(double classic_accuracy, double cross_validation, String path)
            throws IOException {
        ...
        JFreeChart chart = ChartFactory.createBarChart("Naive Bayes Accuracy Results",
                "Accuracy Types", "Results Corresponding as Percent", dataset,
...
//        ChartUtilities.saveChartAsPNG(new File(path+"NB_Model_Chart.png"), chart, 700, 700);
    ...
    public static void DTree_Model_Accuracy_Chart(double classic_accuracy, double cross_validation, String path)
            throws IOException {
        DefaultCategoryDataset dataset = new DefaultCategoryDataset();
        dataset.setValue(classic_accuracy, "%70 - %30 Accuracy", "Accuracy");
        dataset.setValue(cross_validation, "Cross Validation Accuracy", "Accuracy");
        JFreeChart chart = ChartFactory.createBarChart("Decision Tree Accuracy Results",
                "Accuracy Types","Results Corresponding as Percent", dataset,
                PlotOrientation.VERTICAL, true, true, false);
        chart.setBackgroundPaint(Color.white);
        chart.getTitle().setPaint(Color.blue);
    ...
    public static void RF_Tree_Model_Accuracy_Chart(double classic_accuracy, double cross_validation, String path)
            throws IOException {
        DefaultCategoryDataset dataset = new DefaultCategoryDataset();
        dataset.setValue(classic_accuracy, "%70 - %30 Accuracy", "Accuracy");
        dataset.setValue(cross_validation, "Cross Validation Accuracy", "Accuracy");
        JFreeChart chart = ChartFactory.createBarChart("Random Forest Tree Accuracy Results",
                "Accuracy Types","Results Corresponding as Percent", dataset,
                PlotOrientation.VERTICAL, true, true, false);
        chart.setBackgroundPaint(Color.white);
        chart.getTitle().setPaint(Color.blue);
        ...
        // ChartUtilities.saveChartAsPNG(new File(path+"RF_tree_Model_Chart.png"), chart, 700, 700);
    }

    static void Result_Chart(String identifier, double[] K1_Results, double[] K10_Results, double[] K100_Results,
                             double[] K1000_Results, double[] M10_results, double[] M90_results, String path)
            throws IOException {
        ...
        JFreeChart chart = ChartFactory.createBarChart(identifier + "  Sar Results",
                "Total Data Analysed","Results Corresponding as Percent", dataset,
                PlotOrientation.VERTICAL, true, true, false);
        chart.setBackgroundPaint(Color.white);
        chart.getTitle().setPaint(Color.blue);
        CategoryPlot p = chart.getCategoryPlot();
    ...
    static void Analysis_time_chart(double[] NB_time, double[] DTree_time, double[] RFTree_time,
                                    String path) throws IOException {

        DefaultCategoryDataset dataset = new DefaultCategoryDataset();
        dataset.setValue(NB_time[0] / 1000, "Naive Bayes", "1 Img");
        dataset.setValue(DTree_time[0] / 1000, "Decision Tree", "1 Img");
        dataset.setValue(RFTree_time[0] / 1000, "Random Forest Tree", "1 Img");

        dataset.setValue(NB_time[1] / 1000, "Naive Bayes", "10 Img");
        dataset.setValue(DTree_time[1] / 1000, "Decision Tree", "10 Img");
        dataset.setValue(RFTree_time[1] / 1000, "Random Forest Tree", "10 Img");

        dataset.setValue(NB_time[2] / 1000, "Naive Bayes", "100 Img");
        dataset.setValue(DTree_time[2] / 1000, "Decision Tree", "100 Img");
        dataset.setValue(RFTree_time[2] / 1000, "Random Forest Tree", "100 Img");

        dataset.setValue(NB_time[3] / 1000, "Naive Bayes", "1K Img");
        dataset.setValue(DTree_time[3] / 1000, "Decision Tree", "1M Data");
        dataset.setValue(RFTree_time[3] / 1000, "Random Forest Tree", "1M Data");

        dataset.setValue(NB_time[4] / 1000, "Naive Bayes", "10M Data");
        dataset.setValue(DTree_time[4] / 1000, "Decision Tree", "10M Data");
        dataset.setValue(RFTree_time[4] / 1000, "Random Forest Tree", "10K Data");

        dataset.setValue(NB_time[5] / 1000, "Naive Bayes", "90M Data");
        dataset.setValue(DTree_time[5] / 1000, "Decision Tree", "90M Data");
        dataset.setValue(RFTree_time[5] / 1000, "Random Forest Tree", "90M Data");

        JFreeChart chart = ChartFactory.createBarChart(" Total Analysis Time Comparision",
                "Time Model Types","Results Corresponding as Seconds", dataset,
                PlotOrientation.VERTICAL, true, true, false);
        chart.setBackgroundPaint(Color.white);
        chart.getTitle().setPaint(Color.blue);
        CategoryPlot p = chart.getCategoryPlot();
...
/*
    public static void SVM_Model_Accuracy_Chart(double[] classic_accuracy, double[] Cross_validation_accuracy,String path) throws IOException {
        DefaultCategoryDataset dataset = new DefaultCategoryDataset();
